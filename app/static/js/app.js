...
function update_ui(me,him){
  ...
  gsap.to("#mys", {duration: .5, ease: "expo.out", width: p1+"%"});
  gsap.to("#his", {duration: .5, ease: "expo.out", width: p2+"%"});
  var t = new TimelineLite({ paused: true });
  t.set($("#myhand"), {attr:{src:'/static/media/none.png'}}, 0);
  t.set($("#myhand"), {attr:{src:"/static/media/"+me+".png"}}, 5);
  t.set($("#hishand"), {attr:{src:'/static/media/none.png'}}, 0);
  t.set($("#hishand"), {attr:{src:"/static/media/"+him+".png"}}, 5);
  TweenLite.to(t, 0.2, { progress:1, ease:Power4.easeInOut });
  update_text();
...
function update_history(){
  ...
  disp_hist=$("#histcont");
  ic={1:"far fa-laugh-wink win",0:"far fa-meh draw",2:"far fa-sad-tear loss"};



  icons={'r':rock_icons_btn,'p':paper_icons_btn,'s':scissors_icons_btn};
